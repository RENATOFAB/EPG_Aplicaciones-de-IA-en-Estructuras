...
- El objetivo de la investigacion estudiada tuvo como objetivo predecir la resistencia a la compresion de concreto de alta resistencia (HPC) utilizando como herramienta la Inteligencia artificial, especificamente las Redes Neuronales Artificiales (ANN).
